...
export const FETCH_PRODUCT_LIST_SUGGESTION = "FETCH_PRODUCT_LIST_SUGGESTION";
...
export const SUGGESSTION_PRODUCT_CLEAR = "SUGGESSTION_PRODUCT_CLEAR";
...
export const FETCH_PREV_CLEAR = "FETCH_PREV_CLEAR";
